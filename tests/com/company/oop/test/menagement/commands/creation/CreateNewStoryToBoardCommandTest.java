...
class CreateNewStoryToBoardCommandTest {
    ...
    public void before() {
        ...
        command = new CreateNewStoryToBoardCommand(taskManagementRepository);
    }
    ...
    @Test
    public void should_CreateStory_InBoard_IfArguments_AreValid() {
        ...
        List<String> params = List.of(
                ...
                String.valueOf(StorySizeType.LARGE),
                VALID_PERSON,
                VALID_BOARD);
